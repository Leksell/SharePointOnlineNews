...
<%--           /// Ingress Starts here--%>
       <%--Under here I have added an Edit mode panel here for the Ingress (This will show when in edit mode. Added an extra class for branding)--%>
            <PublishingWebControls:EditModePanel ID="EditModePanel1" runat="server" CssClass="edit-mode-panel edit-mode-ingress">
			    <SharePointWebControls:NoteField ID="NoteField1" runat="server"  FieldName="Ingress"/>
		    </PublishingWebControls:EditModePanel>

      <%-- Under here i have added an editmode panel that only show content in Page Display Mode (PageDisplayMode="Display")--%>
		    <PublishingWebControls:EditModePanel ID="EditModePanel2" runat="server" PageDisplayMode="Display">
		        <div class="article-ingress">
			        <SharePointWebControls:FieldValue ID="FieldValue2" runat="server"  FieldName="Ingress"/>
		        </div>
		    </PublishingWebControls:EditModePanel>

<%--            Ingress ends here///--%>

<%--            ///I have removed the ByLine here

			<div class="by-line">
				<SharePointWebControls:TextField FieldName="ArticleByLine" runat="server"/>
			</div>

            And by line ends here/// --%>
		</div>
		<div class="article-content">
			<PublishingWebControls:RichHtmlField FieldName="PublishingPageContent" HasInitialFocus="True" MinimumEditHeight="400px" runat="server"/>
		</div>

<%--        ///I have removed the Roll-up Image field here.
